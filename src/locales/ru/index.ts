export const ru = {
  ...
  promptAddToQueue: "Добавить в очередь",
  promptSplitLinesToQueue: "Разделить строки и добавить в очередь",
  promptQueueEnableHint: "Сначала включите очередь промптов",
  promptEnqueueEmpty: "Нечего добавить в очередь",
  promptsViewPrompts: "Промпты",
  promptsViewChains: "Chains",
  chainSearchPlaceholder: "Поиск chains",
  chainTitleRequired: "Введите имя chain",
  chainStepRequired: "Выберите хотя бы один шаг промпта",
  chainUpdated: "Chain обновлена",
  chainAdded: "Chain добавлена",
  chainMissingPrompt: "Промпт не найден",
  chainEmpty: "Chains пока нет",
  chainEmptyDescription: "Создайте chain, чтобы добавить несколько промптов в очередь по порядку.",
  chainNoSteps: "Нет шагов",
  chainStepCount: "{count} шаг(ов)",
  chainShownInPopover: "Показана в панели выделения",
  chainHiddenInPopover: "Скрыта из панели выделения",
  chainVariablesCount: "{count} переменных",
  chainVariablesNone: "Нет дополнительных переменных",
  chainNoPrompts: "Сначала создайте промпты",
  chainNoPromptsDescription:
    "Chains строятся из существующих промптов и требуют хотя бы один промпт.",
  chainDuplicated: "Chain дублирована",
  chainDeleteConfirm: "Удалить эту chain?",
  chainAdd: "Добавить Chain",
  chainEditorEditTitle: "Изменить Chain",
  chainEditorNewTitle: "Новая Chain",
  chainEditorSubtitle: "Chain добавляет несколько промптов в очередь по порядку",
  chainName: "Имя",
  chainNamePlaceholder: "напр.: процитировать, резюмировать и продолжить",
  chainDescription: "Описание",
  chainDescriptionPlaceholder: "Кратко опишите, что делает эта chain",
  chainIconSvg: "SVG-значок",
  chainIconSvgPlaceholder: '<svg viewBox="0 0 24 24">...</svg>',
  chainIconSvgHelp:
    "Сохраняются только безопасные SVG-узлы и атрибуты. Оставьте пустым для стандартного значка.",
  chainIconSelected: "Значок выбран",
  chainIconNotSelected: "Значок не выбран",
  chainIconSelect: "Выбрать значок",
  chainIconSearchPlaceholder: "Поиск значков... (например: перевод, translate)",
  chainIconClose: "Закрыть",
  chainIconNotFound: "Подходящие значки не найдены",
  chainIconPresetRun: "Выполнить",
  chainIconPresetTranslate: "Перевод",
  chainIconPresetSummary: "Сводка",
  chainIconPresetExpand: "Расширить",
  chainIconPresetPolish: "Отполировать",
  chainIconPresetExplain: "Объяснить",
  chainIconPresetQuestion: "Вопрос",
  chainIconPresetCheck: "Проверить",
  chainIconPresetFix: "Исправить",
  chainIconPresetOptimize: "Оптимизировать",
  chainIconPresetCompare: "Сравнить",
  chainIconPresetReport: "Отчёт",
  chainIconPresetMeeting: "Встреча",
  chainIconPresetEmail: "Письмо",
  chainIconPresetSchedule: "Расписание",
  chainIconPresetPresentation: "Презентация",
  chainIconPresetContract: "Договор",
  chainIconPresetFinance: "Финансы",
  chainIconPresetPlan: "План",
  chainIconPresetArchive: "Архив",
  chainIconPresetStamp: "Согласование",
  chainIconPresetBook: "Чтение",
  chainIconPresetNote: "Заметка",
  chainIconPresetResearch: "Исследование",
  chainIconPresetExperiment: "Эксперимент",
  chainIconPresetThesis: "Диссертация",
  chainIconPresetFormula: "Формула",
  chainIconPresetQuiz: "Тест",
  chainIconPresetHomework: "Задание",
  chainIconPresetReference: "Справка",
  chainIconPresetTutorial: "Обучение",
  chainIconPresetIdea: "Идея",
  chainIconPresetDesign: "Дизайн",
  chainIconPresetPaint: "Рисование",
  chainIconPresetImage: "Изображение",
  chainIconPresetVideo: "Видео",
  chainIconPresetChart: "График",
  chainIconPresetData: "Данные",
  chainIconPresetCalculate: "Расчёт",
  chainIconPresetStatistics: "Статистика",
  chainShowInPopover: "Показывать в панели выделения",
  ...
  chainStepModeInline: "Ввести напрямую",
  chainStepInlinePlaceholder:
    "Введите текст промпта напрямую (поддерживает {{selection}} и {{quote}})",
  chainAddStep: "Добавить шаг",
  chainSelectPrompt: "Выбрать промпт",
  chainVariablesPreview: "Предпросмотр переменных",
  chainExecutionPreview: "Предпросмотр выполнения",
  chainStep: "Шаг",
  chainStepContentEmpty: "Нет содержимого (шаг не настроен)",
  expand: "Развернуть",
  quickQuoteReplyTemplate: "Ответьте на основе цитаты ниже:\n\n{{quote}}",
  quickQuoteJumpToSource: "Перейти к источнику",
  quickQuoteSourceNotFound: "Исходный текст не найден",
  quickQuoteInserted: "Цитата вставлена",
  quickQuoteChainQueued: "Добавлено в очередь: {count}",
  quickQuoteQuote: "Цитата",
  quickQuoteReply: "Ответ с цитатой",
  quickQuoteChainQueueSource: "Chain: {title} · {index}/{total}",
  quickQuoteSettingsTitle: "Цитата выделения",
  quickQuoteSettingsDesc: "Управляет показом всплывающего меню цитаты Ophel на совместимых сайтах.",
  quickQuoteEnabledLabel: "Цитата выделения Ophel",
  quickQuoteEnabledDesc:
    "Если включено, совместимые сайты показывают меню цитаты Ophel после выделения текста. Сайты с нативным меню цитаты остаются под управлением сайта.",
  copied: "Скопировано",
  cleared: "Очищено",
  refreshed: "Обновлено",
  ...
  syncNativePageThemeLabel: "Синхронизировать нативные цвета страницы",
  syncNativePageThemeDesc:
    "Светлый/тёмный режим сайта всегда следует за Ophel. Включите это, чтобы дополнительно менять некоторые цвета нативных элементов (работает только на части сайтов).",
  themeLight: "Светлая",
  themeSystem: "Система",
  customCSS: "CSS-стили",
  ...
  assistantMermaidDownloadPng: "Скачать PNG",
  assistantMermaidFitToPage: "Уместить в экран",
  assistantMermaidZoomOut: "Уменьшить",
  assistantMermaidZoomIn: "Увеличить",
  assistantMermaidFullscreen: "Во весь экран",
  assistantMermaidDownloadSuccess: "PNG скачан",
  assistantMermaidDownloadFailed: "Не удалось скачать PNG",
  assistantMermaidFullscreenFailed: "Не удалось открыть во весь экран",
  ...
  notificationSoundPresetLabel: "Предустановка звука",
  notificationSoundPresetDefault: "По умолчанию",
  notificationSoundPresetSoftChime: "Мягкий звон",
  notificationSoundPresetGlassPing: "Стеклянный сигнал",
  notificationSoundPresetBrightAlert: "Яркое уведомление",
  notificationSoundPreviewButtonLabel: "Прослушать",
  notificationVolumeLabel: "Громкость",
  notificationRepeatCountLabel: "Количество повторов",
  notificationRepeatIntervalLabel: "Интервал повтора",
  notificationSoundPreviewFailed: "Не удалось прослушать звук",
  ...
  privacyModeDesc: "Фальшивый заголовок",
  ...
  outlineScrollBottom: "В конец структуры",
  outlineScrollTop: "В начало структуры",
  ...
  segmentedExportRangePlaceholder: "например 1-3, 8",
  segmentedExportApplyRange: "Применить диапазон",
  segmentedExportSelectVisible: "Выбрать видимые",
  segmentedExportClearVisible: "Очистить видимые",
  segmentedExportInvertVisible: "Инвертировать видимые",
  segmentedExportNoMatches: "Нет сегментов",
  segmentedExportSelected: "Выбрано {selected} / {total}",
  segmentedExportModeZip: "ZIP (Markdown для каждого сегмента)",
  segmentedExportModeMerged: "Объединенный Markdown",
  segmentedExportModeClipboard: "Скопировать Markdown",
  segmentedExportExportSelected: "Экспортировать выбранное",
  segmentedExportSegmentMeta: "{users} пользователь · {assistants} ИИ · около {chars} знаков",
  segmentedExportOpeningSegment: "Начальный ответ",
  segmentedExportUntitledSegment: "Сегмент {index}",
  segmentedExportNoSelection: "Выберите хотя бы один сегмент",
  segmentedExportNoSegments: "Нет сегментов для экспорта",
  ...
  formulaCopyDesc: "Копирует формулу в выбранном формате (не везде)",
  formulaCopyFormatLabel: "Формат копирования",
  formulaCopyFormatDesc: "Копировать исходник LaTeX или MathML по двойному клику",
  formulaCopyFormatLatex: "Исходник LaTeX",
  formulaCopyFormatMathml: "Исходник MathML",
  formulaCopied: "Формула в буфере",
  formulaSourceUnavailable: "У этой формулы нет копируемого исходника",
  formulaFormatUnsupported: "Этот сайт не поддерживает выбранный формат копирования формул",
  formulaDelimiterLabel: "Добавить $ или $$",
  formulaDelimiterDesc: "Автоматически добавляет $ или $$ при копировании LaTeX",
  formulaDelimiterLatexOnlyToast: "Сначала переключите формат копирования на исходник LaTeX",
  ...
  backupValidationPromptChainsType: "promptChains должен быть массивом",
  ...
  webdavProvider: "Провайдер",
  providerJianguoyun: "Nutstore (坚果云)",
  providerJianguoyunHint:
    "Создайте пароль для стороннего приложения в настройках безопасности Nutstore. Не используйте пароль входа.",
  providerJianguoyunPasswordPlaceholder: "Пароль для стороннего приложения",
  providerInfinicloud: "InfiniCloud",
  providerInfinicloudHint: "Подключитесь с помощью email и пароля аккаунта InfiniCloud.",
  providerPcloud: "pCloud",
  providerPcloudHint: "Подключитесь с помощью email и пароля аккаунта pCloud.",
  providerNextcloud: "Nextcloud (Собственный хостинг)",
  providerNextcloudHint:
    "Формат URL: https://your-domain.com/remote.php/dav/files/{имя пользователя}/",
  providerSynology: "Synology NAS (Собственный хостинг)",
  providerSynologyHint:
    "Включите WebDAV в DSM 'Панель управления → Файловые службы → WebDAV'. URL: https://your-nas/webdav/",
  providerSeafile: "Seafile (Собственный хостинг)",
  providerSeafileHint: "Формат URL: https://your-seafile-domain.com/seafdav",
  ...
  defaultDirHint: "По умолчанию: ophel",
...
Выдай код и кратко, что стало лучше.`,
  ...
  shortcutConflictWith: "Конфликтует с",
  shortcutConflict: "",
  ...
  exportOverlayLoadingHistory: "Загружаем весь диалог...",
  exportOverlayPreparing: "Готовим экспорт...",
  exportOverlayExtracting: "Извлекаем диалог...",
  exportOverlayPackaging: "Упаковываем вложения...",
  exportOverlayDownloading: "Сохраняем файл...",
  ...
  outlineUserQueryRoleLabel: "Вопросы пользователя",
  ...
  queueBatchImport: "Массовое добавление",
  queueBatchImportTitle: "Массово добавить в очередь",
  queueBatchImportDesc:
    "Вставьте несколько промптов, разделите их по выбранному правилу и добавьте в очередь.",
  queueBatchTextTab: "Текст",
  queueBatchLibraryTab: "Библиотека промптов",
  queueBatchLibraryModeLabel: "Режим добавления",
  queueBatchLibraryModeSingle: "Каждый промпт отдельным элементом",
  queueBatchLibrarySearchLabel: "Библиотека промптов",
  queueBatchLibrarySearchPlaceholder: "Искать промпты",
  queueBatchLibraryEmpty: "Промпты не найдены",
  queueBatchLibraryVariablePrompt:
    "Перед добавлением в очередь заполните переменные во вкладке промптов",
  queueBatchSplitModeLabel: "Способ разделения",
  queueBatchSplitModeLine: "Разделять по строкам",
  queueBatchSplitModeDelimiter: "Свой разделитель",
  queueBatchDelimiterLabel: "Разделитель",
  queueBatchDelimiterPlaceholder: "Например: \\n или ---",
  queueBatchDelimiterRequired: "Введите разделитель",
  queueBatchInputLabel: "Пакетное содержимое",
  queueBatchInputPlaceholder:
    "Вставьте сюда несколько промптов. После разделения каждый фрагмент попадет в очередь.",
  queueBatchPreviewTitle: "Предпросмотр",
  queueBatchPreviewCount: "Будет добавлено: {count}",
  queueBatchPreviewEmpty: "Нет данных для добавления",
  queueBatchPreviewMore: "Еще {count} не показано",
  queueBatchImportAction: "Добавить в очередь",
  queueBatchImportSuccess: "В очередь добавлено: {count}",
  queueBatchImportEmpty: "Нет промптов для добавления",
  zenModeTitle: "Дзен-режим",
  zenModeLabel: "Включить дзен-режим",
  zenModeDesc:
    "Скрыть боковую панель и элементы навигации для концентрации на текущем разговоре (настраивается индивидуально для каждого сайта)",
  zenModeExitButton: "Выйти из дзен-режима",
  zenModeExitButtonVisibleLabel: "Показывать кнопку выхода",
  zenModeExitButtonVisibleDesc:
    "Если отключено, кнопка выхода из дзен-режима на странице скрывается; выйти из дзен-режима по-прежнему можно через быструю кнопку или сочетание клавиш.",
  cleanModeTitle: "Режим очистки",
  cleanModeLabel: "Включить режим очистки",
  cleanModeDesc:
    "Скрыть отказ от ответственности, рекламу, кнопки загрузки и другие лишние элементы для более чистого интерфейса (настраивается индивидуально для каждого сайта)",
  ...
  joinDiscord: "Присоединиться",
  kofiSupport: "Buy Me a Coffee",
  kofiDesc: "Если Ophel оказался вам полезен, вы можете угостить разработчика кофе",
