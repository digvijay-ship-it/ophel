...
Выдай код и кратко, что стало лучше.`,
  ...
  queueBatchImport: "Массовый импорт",
  queueBatchImportTitle: "Массовый импорт промптов",
  ...
  queueBatchPreviewCount: "Будет импортировано: {count}",
  queueBatchPreviewEmpty: "Нет данных для импорта",
  queueBatchPreviewMore: "Еще {count} не показано",
  queueBatchImportAction: "Импортировать в очередь",
  queueBatchImportSuccess: "Импортировано {count} промпт(ов)",
  queueBatchImportEmpty: "Нет промптов для импорта",
