export const en = {
  ...
  smartEnterLabel: "Smart Enter (Queue Submit)",
  smartEnterDesc: "Queue submission if pressing Enter while upload is in progress",
  pasteFocusFixLabel: "Aggressive Paste Focus",
  pasteFocusFixDesc: "Force focus back to input box after pasting images/files",
  showScrollBtnLabel: "Floating Scroll Button",
  showScrollBtnDesc: "Show a floating button in the corner to scroll to the bottom",
  hideDisclaimerLabel: "Hide Bottom Disclaimer",
  hideDisclaimerDesc: "Hide the disclaimer message at the bottom of the page",
