export const zhTW = {
  ...
  deleteError: "刪除失敗",
  loadFailed: "載入失敗",
  selectFileOrPasteFirst: "請先選擇文件或貼上內容",
  restoreError: "還原失敗",
  backupRestoreConfirmMsg:
    '確定要還原備份 "{name}" 嗎？當前數據將被覆蓋，已打開的 AI 頁面將被刷新。',
  backupDeleteCloudConfirmMsg: '確定要刪除雲端備份 "{name}" 嗎？此操作不可逆。',
  insertFailed: "插入失敗",
  maximize: "最大化",
  browse: "瀏覽...",
  clearAllData: "清除全部資料",
  ...
  promptsViewPrompts: "提示詞",
  promptsViewChains: "Chains",
  chainSearchPlaceholder: "搜尋 Chains",
  chainTitleRequired: "請填寫 Chain 名稱",
  chainStepRequired: "請至少選擇一個提示詞步驟",
  chainUpdated: "Chain 已更新",
  chainAdded: "Chain 已新增",
  chainMissingPrompt: "提示詞不存在",
  chainEmpty: "暫無 Chains",
  chainEmptyDescription: "建立一個 Chain，把多個提示詞按順序加入隊列。",
  chainNoSteps: "暫無步驟",
  chainStepCount: "{count} 個步驟",
  chainShownInPopover: "顯示在選區懸浮層",
  chainHiddenInPopover: "不顯示在選區懸浮層",
  chainVariablesCount: "{count} 個變數",
  chainVariablesNone: "無需填寫額外變數",
  chainNoPrompts: "請先建立提示詞",
  chainNoPromptsDescription: "Chain 由已有提示詞組成，需要至少一個提示詞才能建立。",
  chainDuplicated: "Chain 已複製",
  chainDeleteConfirm: "確定刪除該 Chain？",
  chainAdd: "新增 Chain",
  chainEditorEditTitle: "編輯 Chain",
  chainEditorNewTitle: "新建 Chain",
  chainEditorSubtitle: "Chain 會把多個提示詞按順序加入提示詞隊列",
  chainName: "名稱",
  chainNamePlaceholder: "例如：引用後總結並跟進",
  chainDescription: "描述",
  chainDescriptionPlaceholder: "簡短說明這個 Chain 的用途",
  chainIconSvg: "SVG 圖示",
  chainIconSvgPlaceholder: '<svg viewBox="0 0 24 24">...</svg>',
  chainIconSvgHelp: "僅保留安全 SVG 節點和屬性；留空時使用預設圖示。",
  chainIconSelected: "已選擇圖示",
  chainIconNotSelected: "未選擇圖示",
  chainIconSelect: "選擇圖示",
  chainIconSearchPlaceholder: "搜尋圖示... (例如: 翻譯, translate)",
  chainIconClose: "關閉",
  chainIconNotFound: "未找到符合的圖示",
  chainIconPresetRun: "執行",
  chainIconPresetTranslate: "翻譯",
  chainIconPresetSummary: "總結",
  chainIconPresetExpand: "擴寫",
  chainIconPresetPolish: "潤色",
  chainIconPresetExplain: "解釋",
  chainIconPresetQuestion: "提問",
  chainIconPresetCheck: "檢查",
  chainIconPresetFix: "修正",
  chainIconPresetOptimize: "優化",
  chainIconPresetCompare: "對比",
  chainIconPresetReport: "報告",
  chainIconPresetMeeting: "會議",
  chainIconPresetEmail: "郵件",
  chainIconPresetSchedule: "日程",
  chainIconPresetPresentation: "簡報",
  chainIconPresetContract: "合約",
  chainIconPresetFinance: "財務",
  chainIconPresetPlan: "計劃",
  chainIconPresetArchive: "歸檔",
  chainIconPresetStamp: "審批",
  chainIconPresetBook: "閱讀",
  chainIconPresetNote: "筆記",
  chainIconPresetResearch: "研究",
  chainIconPresetExperiment: "實驗",
  chainIconPresetThesis: "論文",
  chainIconPresetFormula: "公式",
  chainIconPresetQuiz: "測驗",
  chainIconPresetHomework: "作業",
  chainIconPresetReference: "參考",
  chainIconPresetTutorial: "教學",
  chainIconPresetIdea: "創意",
  chainIconPresetDesign: "設計",
  chainIconPresetPaint: "繪畫",
  chainIconPresetImage: "圖片",
  chainIconPresetVideo: "影片",
  chainIconPresetChart: "圖表",
  chainIconPresetData: "資料",
  chainIconPresetCalculate: "計算",
  chainIconPresetStatistics: "統計",
  chainShowInPopover: "顯示在選區懸浮層",
  ...
  chainStepModeInline: "直接輸入",
  chainStepInlinePlaceholder: "直接輸入提示詞內容（支援 {{selection}} 和 {{quote}} 變數）",
  chainAddStep: "新增步驟",
  chainSelectPrompt: "選擇提示詞",
  chainVariablesPreview: "變數預覽",
  chainExecutionPreview: "執行預覽",
  chainStep: "步驟",
  chainStepContentEmpty: "無內容（步驟未設定）",
  expand: "展開",
  quickQuoteReplyTemplate: "請基於下面引用的內容繼續回覆：\n\n{{quote}}",
  quickQuoteJumpToSource: "跳轉到原文",
  quickQuoteSourceNotFound: "未找到原文位置",
  quickQuoteInserted: "引用已插入",
  quickQuoteChainQueued: "已加入隊列 {count} 條",
  quickQuoteQuote: "引用",
  quickQuoteReply: "引用回覆",
  quickQuoteChainQueueSource: "Chain: {title} · {index}/{total}",
  quickQuoteSettingsTitle: "選區引用",
  quickQuoteSettingsDesc: "控制 Ophel 是否在相容網站顯示選區引用浮層。",
  quickQuoteEnabledLabel: "Ophel 選區引用",
  quickQuoteEnabledDesc:
    "開啟後，相容網站選取文字會顯示 Ophel 引用浮層；已有原生引用浮層的網站會自動交由網站處理。",
  copied: "已複製到剪貼簿",
  cleared: "已清除內容",
  refreshed: "已刷新",
  orderUpdated: "已更新排序",
  ...
  privacyModeDesc: "隱藏真實對話標題，顯示偽裝標題",
  ...
  outlineUserQueryRoleLabel: "用戶提問",
  ...
  // 大綱高級工具欄
  outlineScrollBottom: "滾動到大綱底部",
  outlineScrollTop: "滾動到大綱頂部",
  outlineExpandAll: "全部展開",
  outlineCollapseAll: "全部折疊",
  ...
  usageMonitorSettingsTitle: "進階模型本地計數與估算",
  usageMonitorSettingsDesc: "在輸入框附近顯示本地發送次數、閾值進度與粗略 Token 估算",
  usageMonitorExplainLocalOnly:
    "說明：這是純本地估算能力。外掛不會讀取官方剩餘額度，也無法得知伺服器端的真實剩餘次數。",
  usageMonitorExplainNoBackend:
    "行為：僅在本地儲存中記錄計數，並在頁面輸入區附近顯示輕量面板；不會額外改寫站點後端狀態。",
  usageMonitorExplainReset:
    "歸零：平台實際額度重置時間可能不是固定 00:00。自動歸零預設關閉，建議在平台真正重置後手動清零校準。",
  usageMonitorExplainRender:
    "面板會顯示在目前輸入區上方並為正文預留空間；若開啟後出現渲染異常，重新整理頁面即可穩定版面。",
  usageMonitorEnabledLabel: "啟用進階模型對話本地計數與估算",
  usageMonitorEnabledDesc: "透過本地計數與輕量面板，輔助估算目前帳號的大致使用情況",
  usageMonitorDailyLimitLabel: "每日對話次數估算上限",
  usageMonitorDailyLimitDesc: "用於計算 80% / 100% 閾值提醒，僅為本地估算值",
  usageMonitorAutoResetLabel: "啟用自動歸零",
  usageMonitorAutoResetDesc:
    "實驗性：依本地日期切換自動歸零。由於平台實際重置時間可能變動，預設關閉。",
  usageMonitorTodayUsed: "今日已用",
  usageMonitorLocallyUsed: "本地已記",
  usageMonitorInputChars: "輸入字元",
  usageMonitorContextChars: "上下文字元",
  usageMonitorInputTokens: "粗估輸入",
  usageMonitorLoadedConversationTokens: "已載入對話",
  usageMonitorLoadedOutputTokens: "已載入輸出",
  usageMonitorRequestTokens: "目前請求",
  usageMonitorRoundTripTokens: "單輪往返",
  usageMonitorRoundTripDesc: "單輪往返 = 目前請求 + 一次預計回覆的總消耗粗估區間",
  usageMonitorResetButton: "清零",
  usageMonitorManualMode: "手動模式",
  usageMonitorChartTitle: "歷史統計曲線",
  usageMonitorChartDesc: "基於本地記錄的發送事件聚合，可按小時、天、月查看次數或粗估 Tokens。",
  usageMonitorChartHour: "小時",
  usageMonitorChartDay: "天",
  usageMonitorChartMonth: "月",
  usageMonitorChartSiteLabel: "統計站點",
  usageMonitorChartSiteAll: "全部站點",
  usageMonitorChartCurrentSite: "目前統計站點",
  usageMonitorChartMetricCount: "次數",
  usageMonitorChartMetricRequest: "請求 Tokens",
  usageMonitorChartMetricRoundTrip: "往返 Tokens",
  usageMonitorChartMetricConversation: "已載入對話 Tokens",
  usageMonitorChartMetricOutput: "輸出 Tokens",
  usageMonitorChartDelta: "較上一桶",
  usageMonitorChartMaxConversation: "最大單次已載入對話",
  usageMonitorChartMaxRequest: "最大單次請求",
  usageMonitorChartMaxRoundTrip: "最大單次往返",
  usageMonitorChartMaxOutput: "最大單次輸出",
  usageMonitorChartScrollHint: "可左右捲動查看完整時間軸",
  usageMonitorChartEmpty: "暫無統計資料",
  ...
  quickButtonsBehaviorDesc: "調整快捷按鈕組的外觀與互動行為",
  tabConversations: "會話",
  ...
  deleteConvRemoteError: "已從面板刪除，但雲端刪除失敗",
  ...
  segmentedExportMenuItem: "分段匯出...",
  segmentedExportTitle: "分段匯出",
  segmentedExportDetected: "已識別 {count} 個片段",
  segmentedExportSearchPlaceholder: "搜尋片段...",
  segmentedExportRangePlaceholder: "例如 1-3, 8",
  segmentedExportApplyRange: "套用範圍",
  segmentedExportSelectVisible: "選取可見",
  segmentedExportClearVisible: "清空可見",
  segmentedExportInvertVisible: "反選可見",
  segmentedExportNoMatches: "未找到匹配片段",
  segmentedExportSelected: "已選擇 {selected} / {total}",
  segmentedExportModeZip: "ZIP（每段一個 Markdown）",
  segmentedExportModeMerged: "合併為一個 Markdown",
  segmentedExportModeClipboard: "複製為 Markdown",
  segmentedExportExportSelected: "匯出選中",
  segmentedExportSegmentMeta: "{users} 則用戶訊息 · {assistants} 則 AI 回覆 · 約 {chars} 字",
  segmentedExportOpeningSegment: "開場回覆",
  segmentedExportUntitledSegment: "片段 {index}",
  segmentedExportNoSelection: "請至少選擇一個片段",
  segmentedExportNoSegments: "未識別到可匯出的片段",
  ...
  assistantMermaidLabel: "AI 回覆 Mermaid 渲染",
  assistantMermaidDesc: "為未原生支援 Mermaid 的站點自動渲染 AI 回覆中的 Mermaid 圖表",
  userQueryMarkdownLabel: "用戶提問樣式優化",
  userQueryMarkdownDesc: "為用戶提問啟用 Markdown 排版與 LaTeX 數學公式渲染",
  assistantMermaidPreviewTab: "圖表",
  assistantMermaidCodeTab: "程式碼",
  assistantMermaidCopyCode: "複製程式碼",
  assistantMermaidDownloadPng: "下載 PNG",
  assistantMermaidFitToPage: "適應頁面",
  assistantMermaidZoomOut: "縮小",
  assistantMermaidZoomIn: "放大",
  assistantMermaidFullscreen: "全螢幕檢視",
  assistantMermaidDownloadSuccess: "PNG 下載成功",
  assistantMermaidDownloadFailed: "PNG 下載失敗",
  assistantMermaidFullscreenFailed: "全螢幕失敗",
  formulaCopyLabel: "雙擊複製公式",
  formulaCopyDesc: "雙擊數學公式可複製為指定格式（部分站點不支援）",
  formulaCopyFormatLabel: "公式複製格式",
  formulaCopyFormatDesc: "選擇雙擊公式後複製 LaTeX 或 MathML 原始碼",
  formulaCopyFormatLatex: "LaTeX 原始碼",
  formulaCopyFormatMathml: "MathML 原始碼",
  formulaCopied: "公式已複製",
  formulaSourceUnavailable: "目前公式缺少可複製的原始碼",
  formulaFormatUnsupported: "目前站點暫不支援該公式複製格式",
  formulaDelimiterLabel: "複製時添加分隔符",
  formulaDelimiterDesc: "複製 LaTeX 時根據公式類型自動添加 $ 或 $$ 分隔符",
  formulaDelimiterLatexOnlyToast: "請先將公式複製格式切換為「LaTeX 原始碼」",
  ...
  backupValidationPromptChainsType: "promptChains 應為陣列類型",
  ...
  webdavProvider: "服務商",
  providerJianguoyun: "堅果雲",
  providerJianguoyunHint: "請在堅果雲「安全選項」中生成「第三方應用密碼」，不要使用登入密碼。",
  providerJianguoyunPasswordPlaceholder: "第三方應用密碼",
  providerInfinicloud: "InfiniCloud",
  providerInfinicloudHint: "使用 InfiniCloud 帳號信箱和密碼連線。",
  providerPcloud: "pCloud",
  providerPcloudHint: "使用 pCloud 帳號信箱和密碼連線。",
  providerNextcloud: "Nextcloud（自建）",
  providerNextcloudHint:
    "伺服器地址格式：https://your-domain.com/remote.php/dav/files/{使用者名稱}/",
  providerSynology: "群暉 Synology（自建）",
  providerSynologyHint:
    "請在 DSM「控制面板 → 檔案服務 → WebDAV」中開啟服務。地址格式：https://your-nas/webdav/",
  providerSeafile: "Seafile（自建）",
  providerSeafileHint: "伺服器地址格式：https://your-seafile-domain.com/seafdav",
  providerCustom: "自訂",
  learnMore: "了解更多",
...
請直接輸出優化後的程式碼區塊，並在後面附帶簡短的優化點總結。`,
  ...
  shortcutTogglePanelMode: "切換面板模式（自動吸附/懸浮）",
  ...
  exportOverlayLoadingHistory: "正在載入完整對話...",
  exportOverlayPreparing: "正在準備匯出內容...",
  exportOverlayExtracting: "正在擷取對話內容...",
  exportOverlayPackaging: "正在打包附件...",
  exportOverlayDownloading: "正在儲存檔案...",
  exportOverlayCopying: "正在複製 Markdown...",
  exportOverlayRestoring: "正在還原頁面狀態...",
  exportOverlayHint: "匯出期間請保持頁面靜止，不要點擊、捲動或輸入。",
  outlineCopyOverlayLoadingHistory: "正在載入完整對話...",
  outlineCopyOverlayPreparing: "正在準備大綱內容...",
  outlineCopyOverlayExtracting: "正在擷取大綱...",
  outlineCopyOverlayCopying: "正在複製大綱...",
  outlineCopyOverlayRestoring: "正在還原頁面位置...",
  outlineCopyOverlayHint: "複製大綱期間請保持頁面靜止，不要點擊、捲動或輸入。",
  replyCopied: "已複製最新回覆",
  ...
  queueEditCancel: "取消",
  queueForceSend: "強制發送",
  queueBatchImport: "批次加入",
  queueBatchImportTitle: "批次加入隊列",
  queueBatchImportDesc: "貼上多條提示詞後，依所選規則拆分並加入隊列。",
  queueBatchTextTab: "文字",
  queueBatchLibraryTab: "提示詞庫",
  queueBatchLibraryModeLabel: "加入方式",
  queueBatchLibraryModeSingle: "每個提示詞作為一條",
  queueBatchLibrarySearchLabel: "提示詞庫",
  queueBatchLibrarySearchPlaceholder: "搜尋提示詞",
  queueBatchLibraryEmpty: "沒有找到提示詞",
  queueBatchLibraryVariablePrompt: "請先在提示詞 Tab 填寫變數後再加入隊列",
  ...
  "featureTip-panel-mode-toggle-path": "按 {shortcut}，或雙擊面板頂部標題列，快速切換面板顯示模式",
  "featureTip-panel-mode-toggle-path-dblclick": "雙擊面板頂部標題列快速切換面板顯示模式",
  "featureTip-shortcuts-title": "快捷鍵總覽",
  "featureTip-shortcuts-desc": "查看並自訂所有鍵盤快捷鍵",
  "featureTip-shortcuts-path": "{shortcut} 開啟快捷鍵總覽",
  "featureTip-global-search-title": "全域搜尋語法",
  "featureTip-global-search-desc": "支援 folder: tag: site: level: 等過濾語法，精準找到內容",
  "featureTip-global-search-path": "{shortcut} 開啟搜尋，支援 folder: tag: site: 語法",
  "featureTip-copy-reply-title": "一鍵複製最新回覆",
  "featureTip-copy-reply-desc": "快速將最近一則 AI 回覆複製到剪貼簿",
  "featureTip-copy-reply-path": "快捷鍵：{shortcut}",
  "featureTip-prev-next-heading-title": "標題間快速跳轉",
  "featureTip-prev-next-heading-desc": "在大綱標題之間向上或向下快速切換",
  "featureTip-prev-next-heading-path": "快捷鍵：{shortcut}",
  "featureTip-export-conv-title": "匯出對話",
  "featureTip-export-conv-desc": "將選取的對話匯出為 Markdown / JSON / CSV 格式",
  "featureTip-export-conv-path": "對話 Tab → 右上角「批次操作」→ 底部匯出按鈕",
  "featureTip-batch-select-title": "批次操作對話",
  "featureTip-batch-select-desc": "批次刪除、匯出、封存或移動對話",
  "featureTip-batch-select-path": "對話 Tab → 右上角「批次操作」",
  "featureTip-export-markdown-title": "匯出目前對話",
  "featureTip-export-markdown-desc": "將目前頁面的對話匯出為 Markdown 檔案",
  "featureTip-export-markdown-path": "工具箱 → 匯出 Markdown",
  "featureTip-show-user-query-title": "大綱顯示用戶提問",
  "featureTip-show-user-query-desc": "在大綱中同時顯示你的提問，而不只顯示 AI 生成的標題",
  "featureTip-show-user-query-path": "大綱 Tab → ⚡ → 顯示用戶提問",
