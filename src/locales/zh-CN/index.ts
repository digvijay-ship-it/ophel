export const zhCN = {
  ...
  usageMonitorSettingsTitle: "高级模型本地计数与预估",
  usageMonitorSettingsDesc: "在输入框附近显示本地发送计数、阈值进度和粗略 Token 预估",
  ...
  usageMonitorEnabledLabel: "启用高级模型对话本地计数与预估",
  usageMonitorEnabledDesc: "通过本地计数和轻量面板，辅助估算当前账号的大致使用情况",
  usageMonitorDailyLimitLabel: "每日对话次数预估上限",
  usageMonitorDailyLimitDesc: "用于计算 80% / 100% 阈值提醒，仅为本地估算值",
  usageMonitorAutoResetLabel: "启用自动归零",
  usageMonitorAutoResetDesc:
    "实验性：按本地日期切换自动归零。由于平台实际重置时间可能变化，默认关闭。",
  usageMonitorTodayUsed: "今日已用",
  usageMonitorLocallyUsed: "本地已记",
  usageMonitorInputChars: "输入字符",
  usageMonitorContextChars: "上下文字符",
  usageMonitorInputTokens: "粗估输入",
  usageMonitorLoadedConversationTokens: "已加载对话",
  usageMonitorLoadedOutputTokens: "已加载输出",
  usageMonitorRequestTokens: "当前请求",
  usageMonitorRoundTripTokens: "单轮往返",
  usageMonitorRoundTripDesc: "单轮往返 = 当前请求 + 一次预计回复的总消耗粗估区间",
  usageMonitorResetButton: "清零",
  usageMonitorManualMode: "手动模式",
  usageMonitorChartTitle: "历史统计曲线",
  usageMonitorChartDesc: "基于本地记录的发送事件聚合，可按小时、天、月查看次数或粗估 Tokens。",
  usageMonitorChartHour: "小时",
  usageMonitorChartDay: "天",
  usageMonitorChartMonth: "月",
  usageMonitorChartSiteLabel: "统计站点",
  usageMonitorChartSiteAll: "全部站点",
  usageMonitorChartCurrentSite: "当前统计站点",
  usageMonitorChartMetricCount: "次数",
  usageMonitorChartMetricRequest: "请求 Tokens",
  usageMonitorChartMetricRoundTrip: "往返 Tokens",
  usageMonitorChartMetricConversation: "已加载对话 Tokens",
  usageMonitorChartMetricOutput: "输出 Tokens",
  usageMonitorChartDelta: "较上一桶",
  usageMonitorChartMaxConversation: "最大单次已加载对话",
  usageMonitorChartMaxRequest: "最大单次请求",
  usageMonitorChartMaxRoundTrip: "最大单次往返",
  usageMonitorChartMaxOutput: "最大单次输出",
  usageMonitorChartScrollHint: "可左右滚动查看完整时间轴",
  usageMonitorChartEmpty: "暂无统计数据",
  ...
  deleteError: "删除失败",
  loadFailed: "加载失败",
  selectFileOrPasteFirst: "请先选择文件或粘贴内容",
  restoreError: "恢复失败",
  backupRestoreConfirmMsg:
    '确定要恢复备份 "{name}" 吗？当前数据将被覆盖，已打开的 AI 页面将被刷新。',
  backupDeleteCloudConfirmMsg: '确定要删除云端备份 "{name}" 吗？此操作不可逆。',
  insertFailed: "插入失败",
  maximize: "最大化",
  browse: "浏览...",
  clearAllData: "清除全部数据",
  ...
  promptQueued: "已加入队列 {count} 条",
  promptAddToQueue: "加入队列",
  promptSplitLinesToQueue: "按行拆分并加入队列",
  promptQueueEnableHint: "请先启用提示词队列功能",
  promptEnqueueEmpty: "没有可加入队列的内容",
  promptsViewPrompts: "提示词",
  promptsViewChains: "Chains",
  chainSearchPlaceholder: "搜索 Chains",
  chainTitleRequired: "请填写 Chain 名称",
  chainStepRequired: "请至少选择一个提示词步骤",
  chainUpdated: "Chain 已更新",
  chainAdded: "Chain 已添加",
  chainMissingPrompt: "提示词不存在",
  chainEmpty: "暂无 Chains",
  chainEmptyDescription: "创建一个 Chain，把多个提示词按顺序加入队列。",
  chainNoSteps: "暂无步骤",
  chainStepCount: "{count} 个步骤",
  chainShownInPopover: "显示在选区悬浮层",
  chainHiddenInPopover: "不显示在选区悬浮层",
  chainVariablesCount: "{count} 个变量",
  chainVariablesNone: "无需填写额外变量",
  chainNoPrompts: "请先创建提示词",
  chainNoPromptsDescription: "Chain 由已有提示词组成，需要至少一个提示词才能创建。",
  chainDuplicated: "Chain 已复制",
  chainDeleteConfirm: "确定删除该 Chain？",
  chainAdd: "添加 Chain",
  chainEditorEditTitle: "编辑 Chain",
  chainEditorNewTitle: "新建 Chain",
  chainEditorSubtitle: "Chain 会把多个提示词按顺序加入提示词队列",
  chainName: "名称",
  chainNamePlaceholder: "例如：引用后总结并跟进",
  chainDescription: "描述",
  chainIconSelected: "已选择图标",
  chainIconNotSelected: "未选择图标",
  chainIconSelect: "选择图标",
  chainIconSearchPlaceholder: "搜索图标... (如: 翻译, translate)",
  chainIconClose: "关闭",
  chainIconNotFound: "未找到匹配的图标",
  chainIconPresetRun: "运行",
  chainIconPresetTranslate: "翻译",
  chainIconPresetSummary: "总结",
  chainIconPresetExpand: "扩写",
  chainIconPresetPolish: "润色",
  chainIconPresetExplain: "解释",
  chainIconPresetQuestion: "提问",
  chainIconPresetCheck: "检查",
  chainIconPresetFix: "修正",
  chainIconPresetOptimize: "优化",
  chainIconPresetCompare: "对比",
  chainIconPresetReport: "报告",
  chainIconPresetMeeting: "会议",
  chainIconPresetEmail: "邮件",
  chainIconPresetSchedule: "日程",
  chainIconPresetPresentation: "演示",
  chainIconPresetContract: "合同",
  chainIconPresetFinance: "财务",
  chainIconPresetPlan: "计划",
  chainIconPresetArchive: "归档",
  chainIconPresetStamp: "审批",
  chainIconPresetBook: "阅读",
  chainIconPresetNote: "笔记",
  chainIconPresetResearch: "研究",
  chainIconPresetExperiment: "实验",
  chainIconPresetThesis: "论文",
  chainIconPresetFormula: "公式",
  chainIconPresetQuiz: "测验",
  chainIconPresetHomework: "作业",
  chainIconPresetReference: "参考",
  chainIconPresetTutorial: "教程",
  chainIconPresetIdea: "创意",
  chainIconPresetDesign: "设计",
  chainIconPresetPaint: "绘画",
  chainIconPresetImage: "图片",
  chainIconPresetVideo: "视频",
  chainIconPresetChart: "图表",
  chainIconPresetData: "数据",
  chainIconPresetCalculate: "计算",
  chainIconPresetStatistics: "统计",
  chainDescriptionPlaceholder: "简短说明这个 Chain 的用途",
  chainIconSvg: "SVG 图标",
  chainIconSvgPlaceholder: '<svg viewBox="0 0 24 24">...</svg>',
  chainIconSvgHelp: "仅保留安全 SVG 节点和属性；留空时使用默认图标。",
  chainShowInPopover: "显示在选区悬浮层",
  ...
  chainStepModeInline: "直接输入",
  chainStepInlinePlaceholder: "直接输入提示词内容（支持 {{selection}} 和 {{quote}} 变量）",
  chainAddStep: "添加步骤",
  chainSelectPrompt: "选择提示词",
  chainVariablesPreview: "变量预览",
  chainExecutionPreview: "执行预览",
  chainStep: "步骤",
  chainStepContentEmpty: "无内容（步骤未配置）",
  expand: "展开",
  quickQuoteReplyTemplate: "请基于下面引用的内容继续回复：\n\n{{quote}}",
  quickQuoteJumpToSource: "跳转到原文",
  quickQuoteSourceNotFound: "未找到原文位置",
  quickQuoteInserted: "引用已插入",
  quickQuoteChainQueued: "已加入队列 {count} 条",
  quickQuoteQuote: "引用",
  quickQuoteReply: "引用回复",
  quickQuoteChainQueueSource: "Chain: {title} · {index}/{total}",
  quickQuoteSettingsTitle: "选区引用",
  quickQuoteSettingsDesc: "控制 Ophel 是否在兼容站点显示选区引用浮层。",
  quickQuoteEnabledLabel: "Ophel 选区引用",
  quickQuoteEnabledDesc:
    "开启后，兼容站点选中文本会显示 Ophel 引用浮层；已有原生引用浮层的站点会自动交给站点处理。",
  copied: "已复制到剪贴板",
  cleared: "已清理",
  refreshed: "已刷新",
  orderUpdated: "已更新排序",
  ...
  notificationSoundPresetLabel: "提示音预设",
  notificationSoundPresetDefault: "默认",
  notificationSoundPresetSoftChime: "轻柔铃音",
  notificationSoundPresetGlassPing: "清脆玻璃音",
  notificationSoundPresetBrightAlert: "明亮提醒",
  notificationSoundPreviewButtonLabel: "试听",
  notificationVolumeLabel: "声音音量",
  notificationRepeatCountLabel: "播放次数",
  notificationRepeatIntervalLabel: "播放间隔",
  notificationSoundPreviewFailed: "提示音试听失败",
  ...
  privacyModeDesc: "隐藏真实对话标题，显示伪装标题",
  ...
  outlineUserQueryRoleLabel: "用户提问",
  ...
  anchorUpdated: "锚点已更新",
  // 大纲高级工具栏
  outlineScrollBottom: "滚动到大纲底部",
  outlineScrollTop: "滚动到大纲顶部",
  ...
  assistantMermaidDownloadPng: "下载 PNG",
  assistantMermaidFitToPage: "适应页面",
  assistantMermaidZoomOut: "缩小",
  assistantMermaidZoomIn: "放大",
  assistantMermaidFullscreen: "全屏查看",
  assistantMermaidDownloadSuccess: "PNG 下载成功",
  assistantMermaidDownloadFailed: "PNG 下载失败",
  assistantMermaidFullscreenFailed: "全屏失败",
  ...
  conversationsDeleteConvMsg: '确定删除会话 "{title}" 吗？',
  confirmDeleteSelectedConvs: "确定删除选中的 {count} 个会话吗？",
  batchDeleteSuccessWithRemoteErrors:
    "已删除 {localDeletedCount} 个，本地成功，云端失败 {remoteFailedCount} 个",
  ...
  conversationsSyncResult:
    "同步完成：扫描 {scanned} 条，新增 {added} 条，更新 {updated} 条，删除 {deleted} 条",
  ...
  deleteConvRemoteError: "已从面板删除，但云端删除失败",
  ...
  segmentedExportMenuItem: "分段导出...",
  segmentedExportTitle: "分段导出",
  segmentedExportDetected: "已识别 {count} 个片段",
  segmentedExportSearchPlaceholder: "搜索片段...",
  segmentedExportRangePlaceholder: "例如 1-3, 8",
  segmentedExportApplyRange: "应用范围",
  segmentedExportSelectVisible: "选择可见",
  segmentedExportClearVisible: "清空可见",
  segmentedExportInvertVisible: "反选可见",
  segmentedExportNoMatches: "未找到匹配片段",
  segmentedExportSelected: "已选择 {selected} / {total}",
  segmentedExportModeZip: "ZIP（每段一个 Markdown）",
  segmentedExportModeMerged: "合并为一个 Markdown",
  segmentedExportModeClipboard: "复制为 Markdown",
  segmentedExportExportSelected: "导出选中",
  segmentedExportSegmentMeta: "{users} 条用户消息 · {assistants} 条 AI 回复 · 约 {chars} 字",
  segmentedExportOpeningSegment: "开场回复",
  segmentedExportUntitledSegment: "片段 {index}",
  segmentedExportNoSelection: "请选择至少一个片段",
  segmentedExportNoSegments: "未识别到可导出的片段",
  ...
  // 面板位置设置
  defaultPositionLabel: "默认侧边",
  defaultPositionDesc: "面板展开时优先使用的侧边；自动吸附没有当前侧边时也作为兜底",
  ...
  formulaCopyDesc: "双击数学公式可复制为指定格式（部分站点不支持）",
  formulaCopyFormatLabel: "公式复制格式",
  formulaCopyFormatDesc: "选择双击公式后复制 LaTeX 或 MathML 源码",
  formulaCopyFormatLatex: "LaTeX 源码",
  formulaCopyFormatMathml: "MathML 源码",
  formulaCopied: "公式已复制",
  formulaSourceUnavailable: "当前公式缺少可复制的源码",
  formulaFormatUnsupported: "当前站点暂不支持该公式复制格式",
  formulaDelimiterLabel: "复制时添加分隔符",
  formulaDelimiterDesc: "复制 LaTeX 时根据公式类型自动添加 $ 或 $$ 分隔符",
  formulaDelimiterLatexOnlyToast: "请先将公式复制格式切换为「LaTeX 源码」",
  ...
  backupValidationPromptChainsType: "promptChains 应为数组类型",
  ...
  webdavProvider: "服务商",
  providerJianguoyun: "坚果云",
  providerJianguoyunHint: "请在坚果云「安全选项」中生成「第三方应用密码」，不要使用登录密码。",
  providerJianguoyunPasswordPlaceholder: "第三方应用密码",
  providerInfinicloud: "InfiniCloud",
  providerInfinicloudHint: "使用 InfiniCloud 账号邮箱和密码连接。",
  providerPcloud: "pCloud",
  providerPcloudHint: "使用 pCloud 账号邮箱和密码连接。",
  providerNextcloud: "Nextcloud（自建）",
  providerNextcloudHint: "服务器地址格式：https://your-domain.com/remote.php/dav/files/{用户名}/",
  providerSynology: "群晖 Synology（自建）",
  providerSynologyHint:
    "请在 DSM「控制面板 → 文件服务 → WebDAV」中开启服务。地址格式：https://your-nas/webdav/",
  providerSeafile: "Seafile（自建）",
  providerSeafileHint: "服务器地址格式：https://your-seafile-domain.com/seafdav",
  providerCustom: "自定义",
  learnMore: "了解更多",
...
请直接输出优化后的代码块，并在后面附带简短的优化点总结。`,
  ...
  shortcutTogglePanelMode: "切换面板模式（自动吸附/悬浮）",
  ...
  exportOverlayLoadingHistory: "正在加载完整对话...",
  exportOverlayPreparing: "正在准备导出内容...",
  exportOverlayExtracting: "正在提取对话内容...",
  exportOverlayPackaging: "正在打包附件...",
  exportOverlayDownloading: "正在保存文件...",
  exportOverlayCopying: "正在复制 Markdown...",
  exportOverlayRestoring: "正在恢复页面状态...",
  exportOverlayHint: "导出期间请保持页面静止，不要点击、滚动或输入。",
  outlineCopyOverlayLoadingHistory: "正在加载完整对话...",
  outlineCopyOverlayPreparing: "正在准备大纲内容...",
  outlineCopyOverlayExtracting: "正在提取大纲...",
  outlineCopyOverlayCopying: "正在复制大纲...",
  outlineCopyOverlayRestoring: "正在恢复页面位置...",
  outlineCopyOverlayHint: "复制大纲期间请保持页面静止，不要点击、滚动或输入。",
  replyCopied: "已复制最新回复",
  ...
  globalSearchEmptyTips: "未找到匹配的功能技巧",
  ...
  queueEditCancel: "取消",
  queueForceSend: "强制发送",
  queueBatchImport: "批量加入",
  queueBatchImportTitle: "批量加入队列",
  queueBatchImportDesc: "粘贴多条提示词后，按所选规则拆分并加入队列。",
  queueBatchTextTab: "文本",
  queueBatchLibraryTab: "提示词库",
  queueBatchLibraryModeLabel: "加入方式",
  queueBatchLibraryModeSingle: "每个提示词作为一条",
  queueBatchLibrarySearchLabel: "提示词库",
  queueBatchLibrarySearchPlaceholder: "搜索提示词",
  queueBatchLibraryEmpty: "没有找到提示词",
  queueBatchLibraryVariablePrompt: "请先在提示词 Tab 填写变量后再加入队列",
  queueBatchSplitModeLabel: "拆分方式",
  queueBatchSplitModeLine: "按行拆分",
  queueBatchSplitModeDelimiter: "自定义分隔符",
  queueBatchDelimiterLabel: "分隔符",
  queueBatchDelimiterPlaceholder: "例如：\\n、---",
  queueBatchDelimiterRequired: "请输入分隔符",
  queueBatchInputLabel: "批量内容",
  queueBatchInputPlaceholder: "粘贴多条提示词，每条按规则拆分后入队",
  queueBatchPreviewTitle: "预览",
  queueBatchPreviewCount: "将导入 {count} 条",
  queueBatchPreviewEmpty: "暂无可导入内容",
  queueBatchPreviewMore: "还有 {count} 条未展示",
  ...
  releaseNotesPublishedOn: "发布于 {date}",
  releaseNotesOpen: "查看更新日志",
  releaseNotesViewFull: "查看完整更新日志",
  releaseNotesGotIt: "我知道了",
  // 功能技巧：全局搜索 ? 前缀帮助模式
  featureTipSearchPlaceholder: "搜索功能技巧…",
  featureTipShortcutNotConfigured: "快捷键未配置",
  featureTipToastTryShortcut: "试试快捷键：{shortcut}",
  featureTipsCategory: "功能技巧",
  "featureTip-passthrough-title": "穿透模式",
  "featureTip-passthrough-desc": "让面板变透明，直接点击/选中下方页面内容",
  "featureTip-passthrough-path": "长按 {modifier}，面板变透明，可操作下层内容",
  "featureTip-panel-mode-toggle-title": "切换面板模式",
  "featureTip-panel-mode-toggle-desc": "快速在悬浮面板和自动吸附边缘模式之间切换",
  "featureTip-panel-mode-toggle-path": "按 {shortcut}，或双击面板顶部标题栏，快速切换面板显示模式",
  "featureTip-panel-mode-toggle-path-dblclick": "双击面板顶部标题栏快速切换面板显示模式",
  "featureTip-shortcuts-title": "快捷键总览",
  "featureTip-shortcuts-desc": "查看并自定义所有键盘快捷键",
  "featureTip-shortcuts-path": "{shortcut} 打开快捷键总览",
  "featureTip-global-search-title": "全局搜索语法",
  "featureTip-global-search-desc": "支持 folder: tag: site: level: 等过滤语法，精准定位内容",
  "featureTip-global-search-path": "{shortcut} 打开搜索，支持 folder: tag: site: 语法",
  "featureTip-copy-reply-title": "一键复制最新回复",
  "featureTip-copy-reply-desc": "快速将最近一条 AI 回复复制到剪贴板",
  "featureTip-copy-reply-path": "快捷键：{shortcut}",
  "featureTip-prev-next-heading-title": "标题间快速跳转",
  "featureTip-prev-next-heading-desc": "在大纲标题之间向上 / 向下跳转",
  "featureTip-prev-next-heading-path": "快捷键：{shortcut}",
  "featureTip-export-conv-title": "导出会话",
  "featureTip-export-conv-desc": "将选中会话导出为 Markdown / JSON / CSV 格式",
  "featureTip-export-conv-path": "会话 Tab → 右上角「批量操作」→ 底部导出按钮",
  "featureTip-batch-select-title": "批量操作会话",
  "featureTip-batch-select-desc": "批量删除、导出、归档或移动会话",
  "featureTip-batch-select-path": "会话 Tab → 右上角「批量操作」",
  "featureTip-export-markdown-title": "导出当前对话",
  "featureTip-export-markdown-desc": "将当前页面对话导出为 Markdown 文件",
  "featureTip-export-markdown-path": "工具箱 → 导出",
  "featureTip-show-user-query-title": "大纲显示用户提问",
  "featureTip-show-user-query-desc": "在大纲中同时显示用户的提问，而不仅是 AI 的章节标题",
  "featureTip-show-user-query-path": "大纲 Tab → ⚡ → 显示用户提问",
