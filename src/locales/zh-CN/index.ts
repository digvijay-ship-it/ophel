export const zhCN = {
  ...
  smartEnterLabel: "智能回车（排队提交）",
  smartEnterDesc: "在图片/附件上传时按回车，将排队等上传完自动提交",
  pasteFocusFixLabel: "粘帖强制聚焦",
  pasteFocusFixDesc: "粘帖图片或文件后，强制焦点保持在输入框",
  showScrollBtnLabel: "悬浮滚动按钮",
  showScrollBtnDesc: "在右下角显示一个一键滚动到底部的悬浮按钮",
  hideDisclaimerLabel: "隐藏底部免责声明",
  hideDisclaimerDesc: "隐藏页面底部的免责声明文字",
