...
最適化されたコードブロックを直接出力し、その後に改善点の簡潔な要約を添えてください。`,
  ...
  queueForceSend: "強制送信",
  queueBatchImport: "一括インポート",
  queueBatchImportTitle: "プロンプトを一括インポート",
  ...
  queueBatchPreviewCount: "{count}件をインポートします",
  queueBatchPreviewEmpty: "インポートできる内容がありません",
  queueBatchPreviewMore: "さらに {count} 件あります",
  queueBatchImportAction: "キューに追加",
  queueBatchImportSuccess: "{count}件のプロンプトをインポートしました",
  queueBatchImportEmpty: "インポートできるプロンプトがありません",
  zenModeTitle: "禅モード",
